...
namespace Bloxstrap
{
    public class Bootstrapper
    {
        ...
        private string _playerModFolder => _launchMode == LaunchMode.Studio ? Paths.StudioModifications : Paths.PlayerModifications;

        private List<string> _modManifest
        {
            get
            {
                return _launchMode == LaunchMode.Studio ? App.RobloxState.Prop.StudioModManifest : App.RobloxState.Prop.PlayerModManifest;
            }

            set
            {
                if (_launchMode == LaunchMode.Studio)
                    App.RobloxState.Prop.StudioModManifest = value;
                else
                    App.RobloxState.Prop.PlayerModManifest = value;
            }
        }
